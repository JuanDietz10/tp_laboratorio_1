...
#define MSG_ERROR_GENERAL        " Error, the operation has not been successfully processed"
#define MSG_ERROR_FACT_OVERFLOW  "  Factorial overflow. Cannot calculate number factorial bigger than 12"
#define MSG_ERROR_MULT_OVERFLOW  "  Multiplication overflow"
...
#define MSG_SET_VALUES           "  Set values?       Yes (enter)"
