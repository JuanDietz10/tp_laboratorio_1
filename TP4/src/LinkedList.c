...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this != NULL && nodeIndex >= 0)
    {
		...
		if(pNode != NULL)
		{
			...
			{
				if((pPrevNode = getNode(this, this->size-1)) != NULL)
				{
			...
			{
				if((pPrevNode = getNode(this, nodeIndex-1)) != NULL)
				{
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >= 0 && index < this->size)
    {
    	...
    	if(pNode != NULL)
    	{
			...
			{
				if((pPrevNode = getNode(this, index-1)) != NULL)
...
void* ll_pop(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >= 0 && index < this->size)
    {
    	Node *pNode = NULL;
    	Node *pRetNode = NULL;
    	pRetNode = (Node*)malloc(sizeof(Node));
...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    if(this != NULL && pFunc != NULL && order >= 0 && order < 2)
    {
    	...
    	do
    	{
			...
			{
				if((pNode1 = getNode(this, i)) != NULL && (pNode2 = getNode(this, i+1)) != NULL)
				{
					if((pFunc(pNode1->pElement, pNode2->pElement) > 0 && order == 1) ||
					   (pFunc(pNode1->pElement, pNode2->pElement) < 0 && order == 0))
					{
						flagswap = 1;
						if((pElement = ll_pop(this, i+1)))
