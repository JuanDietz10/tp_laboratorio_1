...
#define MSG_ERROR_FACT_NEGATIVE  "  No se puede calcular el factorial de un número negativo"
#define MSG_ERROR_GENERAL        " Error, la operacion no se ha podido procesar correctamente"
#define MSG_ERROR_FACT_OVERFLOW  "  Limite de valores sobrepasado, No se puede calcular el factorial de un número mayor a 12"
...
#define MSG_PRINT_MULTIPLICATION "  El resultado de A*B es: "
#define MSG_PRINT_DIVISION       "  El resultado de A/B es: "
#define MSG_PRINT_FACTORIAL_A    "  El resultado de A!  es: "
#define MSG_PRINT_FACTORIAL_B    "  El resultado de B!  es: "
